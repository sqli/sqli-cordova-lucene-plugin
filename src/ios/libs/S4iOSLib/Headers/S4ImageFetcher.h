...
- (void)imageFetcher: (S4ImageFetcher *)fetcher didFailWithError: (NSError *)error context: (id)userObject;
...
@property (readonly, copy, nonatomic) NSString					*imageTag;

// Class methods
+ (id)fetcherForImageAtURL: (NSString *)urlStr
			  withDelegate: (NSObject <S4ImageFetcherDelegate> *)delegate
				   context: (id)userObject
	   usingOperationQueue: (NSOperationQueue *)queue;

// Instance methods
- (BOOL)loadImageAtURL: (NSString *)urlStr
		  withDelegate: (NSObject <S4ImageFetcherDelegate> *)delegate
			   context: (id)userObject;
