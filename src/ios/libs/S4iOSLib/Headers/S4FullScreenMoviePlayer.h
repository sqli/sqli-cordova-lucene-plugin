...
// Properties
@property (readwrite, copy, nonatomic) NSURL					*contentURL;
...
- (BOOL)playMovieForViewController: (UIViewController *)viewController
					  withDelegate: (NSObject <S4FullScreenMovieDelegate> *)delegate;
- (void)stopMovie;
