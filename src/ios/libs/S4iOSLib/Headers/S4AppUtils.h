...
// retrieve the bundle ID from the info.plist
- (NSString *)bundleID;

// returns a formatted date string (using a format string)
- (NSString *)formattedDateString: (NSString *)formatStr
						 fromDate: (NSDate *)dateToFormat;

// Generic "open URL" with another application method
- (void)openApplicationWithUrlStr: (NSString *)urlStr;

// Mail methods
- (void)sendCCMailWithAddressStr: (NSString *)addressStr
							  cc: (NSString *)ccStr 
						 subject: (NSString *)subjectStr
							body: (NSString *)bodyStr;
- (void)sendHtmlCCMailWithAddressStr: (NSString *)addressStr
								  cc: (NSString *)ccStr 
							 subject: (NSString *)subjectStr
							htmlBody: (NSString *)htmlBodyStr;
...
// Map methods
- (void)openMapsWithAddressStr: (NSString *)addressStr
