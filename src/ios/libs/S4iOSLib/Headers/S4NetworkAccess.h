...
S4_EXTERN_CONSTANT_NSSTR						kS4NetworkChangedNotification;
...
@protocol S4NetworkAccessDelegate <NSObject>

@required
- (void)networkAccessChanged: (S4NetworkAccess *)networkAccess;
...
- (BOOL)addDelegate: (NSObject <S4NetworkAccessDelegate> *)newDelegate;
- (BOOL)removeDelegate: (NSObject <S4NetworkAccessDelegate> *)removeDelegate;
